...
function convert_to_unicode0()
{
    ...
    var modified_substring = document.getElementById("legacy_text0").value;


    var text_size = document.getElementById("legacy_text0").value.length;
    ...
    while (chale_chalo == 1)
    {
        ...
        if (sthiti2 < (text_size - max_text_size))
        {
            ...
            while (document.getElementById("legacy_text0").value.charAt(sthiti2) != ' ') {
                sthiti2--;
            }
        } else {
            sthiti2 = text_size;
        ...
        var modified_substring = document.getElementById("legacy_text0").value.substring(sthiti1, sthiti2);

        Replace_Symbols( );

        processed_text += modified_substring;
        // CKEDITOR.instances.editor1.setData(data.data.description).value=processed_text;; 

        document.getElementById("legacy_text0").value = processed_text;
        document.getElementById("cke_question-question_desc").value = processed_text;
