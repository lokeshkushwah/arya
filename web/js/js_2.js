...
function convert_to_unicode2()
{
    ...
    var modified_substring = document.getElementById("legacy_text2").value;


    var text_size = document.getElementById("legacy_text2").value.length;
    ...
    while (chale_chalo == 1)
    {
        ...
        if (sthiti2 < (text_size - max_text_size))
        {
            ...
            while (document.getElementById("legacy_text2").value.charAt(sthiti2) != ' ') {
                sthiti2--;
            }
        } else {
            sthiti2 = text_size;
        ...
        var modified_substring = document.getElementById("legacy_text2").value.substring(sthiti1, sthiti2);

        Replace_Symbols( );

        processed_text += modified_substring;

        document.getElementById("question-question_option2").value = processed_text;
