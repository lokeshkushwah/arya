...
//$this->params['breadcrumbs'][] = $this->title;
        ...
        <div class="col-md-12">
                        ...
                        if (Yii::$app->user->id) {
                            ...
                            $list= Yii::$app->db->createCommand("SELECT * FROM exam LEFT JOIN exam_user ON exam.id=exam_user.exam LEFT JOIN user ON exam_user.user=user.id WHERE user.batch=$batch_find GROUP BY exam.exam_title order by exam.id DESC limit 100")->queryAll();
                            ...
                            <table class="table table-striped table-bordered">
                                ...
                                <td> <a href="<?php echo \yii\helpers\Url::to(['site/exam-results', 'exam' => $exam_list['exam_title']]); ?>" >Show</a> </td>
                                </tr>
    ...
    ?>
            ...
            $institute = \app\models\User::find()->where(['user.id' => Yii::$app->user->id,'batch'=>Yii::$app->user->identity->batch])->all();
