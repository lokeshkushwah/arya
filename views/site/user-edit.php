...
<br/><br/>
    ...
    <?= $form->field($model, 'username')->textInput(['maxlength' => true]) ?>
       <?php // $form->field($model, 'batch')->dropDownList(\yii\helpers\ArrayHelper::map(app\models\Batch::find()->where('name !="admin"')->all(), 'id', 'name')) ?>


        <?php // $form->field($model, 'batch')->hiddenInput(['value'=> 8])->label(false) ?>
