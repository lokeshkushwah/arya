                ...
                <div class="container-fluid">
                    ...
                    <div id="navbar" class="navbar-collapse collapse">
                        <ul class="nav navbar-nav">
                            <li class="active"><a href="<?php yii\helpers\Url::to('site/index', TRUE) ?>">Home</a></li>
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Step1 <span class="caret"></span></a>
            ...
            echo Nav::widget([
                ...
                'items' => [
                    ...
                    //['label' => 'About', 'url' => ['/site/about']],
                        ...
                        'label' => 'Step 1',
                        'items' => [
                            ['label' => '1.1. Subject', 'url' => ['/subject']],
                            '<li class="divider"></li>',
							['label' => '1.2 Question', 'url' => ['/question']],
                          
                            '<li class="divider"></li>',
                             ['label' => '1.3. Exam', 'url' => ['/exam']],
                             '<li class="divider"></li>',
                              ['label' => '1.4 Paper', 'url' => ['/paper']],
                             '<li class="divider"></li>',
                              ['label' => '1.5 User-Exam', 'url' => ['/exam-user']],
                        ],
                    ],
/*                    [
                        'label' => 'Step 1',
